...
**Sprachen:** [English](architecture.md) (Standard) · Deutsch (diese Datei, Original)

Referenzarchitektur der Minimalvariante. Die Auftragsgeschichte steht in
`docs/llm-cms.md`, die Kritik an v0.1 in `docs/feedback.de.md` und im Audit; dieses
...
Container-Image mit exakter Toolchain — Rückstand in `docs/roadmap.de.md`.
...
die Bedingungen für jede Ergänzung: `docs/roadmap.de.md`.
